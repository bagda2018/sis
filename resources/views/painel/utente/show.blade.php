...
{{ Form::model( $utente, ['route' => ['utente.update',$utente->id], 'class' => 'form' ] ) }}
<!-- ROW 1 -->
        ...
        <div class="panel panel- panel-info">   
            <div class="panel-heading">
                ...
                <div class="form-actions right" style="margin-top:-10px">
                    <a data-toggle="tooltip" title="Editar" href=" {{route('utente.edit',$utente->id) }} ">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {{  Form::text('entidade_financeira',$utente->entidade_financeira->name, array('placeholder'=>'sis@hotmail.com','class'=> 'form-control','disabled'=>'')) }}
                    </div>
                </div>
