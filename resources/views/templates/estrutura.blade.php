...
<script src="../../maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>-->
    ...
    <!--    <script>window.jQuery || document.write('<script src="../../../web/funcionarios/js/jquery-1.11.2.min.js"><\/script>')</script>
        <script src="../../../web/funcionarios/js/modernizr.js"></script>
        <script src="../../../web/funcionarios/js/bootstrap.min.js"></script>
        <script src="../../../web/funcionarios/js/jquery.mCustomScrollbar.concat.min.js"></script>
        <script src="../../../web/funcionarios/js/main.js"></script>-->
    ...
    <body>      
        ...
        <!--<script src="assets/plugins/jquery-2.1.0.js"></script>-->
        <script src="{{ url('assets/plugins/jquery-2.1.0.js' )}}" type="text/javascript"></script>
